...
angular.module('educationalTermsApp.services', ['ngResource'])
.constant("baseURL", "http://192.168.43.107:3000/")
// .constant("baseURL", "http://localhost:3000/")

.factory('termFactory', ['$resource', 'baseURL', function ($resource, baseURL) {
    return $resource(baseURL + "terms/:id", null, {
            'update': {
                method: 'PUT'
            }
        });
...
.factory('commentFactory', ['$resource', 'baseURL', function ($resource, baseURL) {
    return $resource(baseURL + "terms/:id/comments/:commentId", {id:"@Id", commentId: "@CommentId"}, {
        'update': {
            method: 'PUT'
        }
    });
...
.factory('favoriteFactory', ['$resource', 'baseURL', function ($resource, baseURL) {
    return $resource(baseURL + "favourites/:id", null, {
            'update': {
                method: 'PUT'
            }
        });
